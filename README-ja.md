...
本作品は元は高校時代に個人的な練習で作ったものですが、著作権上マズい素材をふんだんに使っていたので、公開にあたり全て置き換えています。

音声素材は、以下の通り [OtoLogic](https://otologic.jp/) にて [CC-BY-4.0](LICENSE.OtoLogic) で配布されているものです。効果音は適宜形式変換やカット編集を施しています。
